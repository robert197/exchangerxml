/*
 * $Id: AnyElementDetailsPanel.java,v 1.3 2005/08/25 10:48:21 gmcgoldrick Exp $
 *
...
/**
 * The (wildcard) Element details panel.
 *
 * @version	$Revision: 1.3 $, $Date: 2005/08/25 10:48:21 $
 * @author Dogsbay
 */
public class AnyElementDetailsPanel extends BaseDetailsPanel {
...
//	private JLabel namespace 		= null; // default
	private JLabel occurs 			= null;
	private JList namespaces		= null;

	public AnyElementDetailsPanel( SchemaViewerDetails schemaViewer) {
		super( "Any Element");
	...
	public void setWildcard( AnySchemaElement wildcard) {
