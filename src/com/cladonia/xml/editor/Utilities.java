...
public class Utilities {
    ...
    public static final int getRowStart(JTextComponent c, int offs) throws BadLocationException {
    	XmlEditorPane e = (XmlEditorPane)c;
    	
		Rectangle r = e.modelToView(offs);
		if (r == null) {
		    return -1;
		}
		...
		while ((r != null) && (y == r.y)) {
		    ...
		    if ( (lastOffs >= 0)) {
		    	...
		    	if ( temp != null) {
		    		...
		    		Vector folds = e.getFoldingMargin().getFolds();
...
//		    	System.out.println( "ERROR: Position not represented by view: "+lastOffs);
		    	break;
		    }
		}
		return offs;
    ...
    static int getNextVisualPositionFrom(View v, int pos, Position.Bias b,
		...
		retValue = child.getNextVisualPositionFrom(-1, biasRet[0],
            ...
            if ((direction == SwingConstants.EAST ||
                 direction == SwingConstants.WEST) &&
                (v instanceof FoldingCompositeView) &&
                ((FoldingCompositeView)v).flipEastAndWestAtEnds(pos, b)) {
                increment *= -1;
            }
