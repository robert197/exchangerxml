 ...
 */
public class BufferContent extends GapVector implements AbstractDocument.Content, Serializable {

    // --- variables --------------------------------------

    private static final char[] empty = new char[0];
    private transient MarkVector marks;
    private transient Vector stickies = null;
...
//			}
    ...
    public Position createPosition(int offset) throws BadLocationException {
		...
		StickyPosition sticky = new StickyPosition(m);
		stickies.addElement( sticky);
	...
	public void cleanup() {
		if ( marks != null) {
			...
			for ( int i = 0; i < stickies.size(); i++) {
				((StickyPosition)stickies.elementAt( i)).cleanup();
			}
