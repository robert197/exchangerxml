/*
 * $Id: ExpandAllAction.java,v 1.1 2004/03/25 18:51:00 edankert Exp $
 *
 ...
 public class ExpandAllAction extends AbstractAction {
	 ...
	 */
 	public ExpandAllAction( Viewer viewer) {
		...
		putValue( SMALL_ICON, XngrImageLoader.get().getImage( "com/cladonia/xml/viewer/icons/ExpandAll.gif"));
