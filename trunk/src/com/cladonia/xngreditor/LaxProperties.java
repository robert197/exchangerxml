 ...
 * @since   JDK1.0
 */
public class LaxProperties extends Properties {
    /**
...
//    protected Properties defaults;
     ...
     */
    public LaxProperties( Properties defaults) {
		super( defaults);
    }
...
//    }
    ...
    throws IOException
    {
        ...
        if (header != null)
            writeln(awriter, "#   LaunchAnywhere (tm) Executable Properties File - Zero G Software, Inc.");
            writeln(awriter, "#   Updated by the Exchanger XML Editor (tm) Cladonia Ltd. ("+new Date().toString()+")");
            writeln(awriter, "#   Do not edit!");
