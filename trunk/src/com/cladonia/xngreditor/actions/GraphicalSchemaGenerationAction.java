...
import com.cladonia.schema.generate.GraphicalSchemaGenerationDialog;
import com.cladonia.schema.generate.GraphicalSchemaGenerator;
import com.cladonia.schema.viewer.RootSelectionDialog;
//import com.cladonia.schema.generate.RootSelectionDialog;
 ...
 */
public class GraphicalSchemaGenerationAction extends AbstractAction
{
  
  private static final boolean DEBUG = false;
  
  private ConfigurationProperties properties = null;
  private GraphicalSchemaGenerationDialog dialog = null;
   ...
   *            the parent frame.
   */
  public GraphicalSchemaGenerationAction(ExchangerEditor parent,
      ConfigurationProperties properties)
  {
    super("Graphical Schema Generation");
    
    putValue(MNEMONIC_KEY, new Integer('I'));
    putValue(SHORT_DESCRIPTION, "Generate graph from XML Schema.");
  ...
  {
    // System.out.println( "GraphicalSchemaGenerationAction.actionPerformed(
    // "+e+")");
    if (chooser == null)
    {
    ...
    if (!chooser.isCancelled())
    {
      try
      {
        ...
        {
          MessageHandler
              .showError(parent, "Cannot Generate Graph from Schema",
              "Generate Schema Graph Error");
        ...
        if (dialog == null)
        {
          dialog = new GraphicalSchemaGenerationDialog(parent, properties);
        }
        ...
        if (!dialog.isCancelled())
        {
          ...
          if (schemaRoot != null)
          {
            ...
            GraphicalSchemaGenerator gsg = new GraphicalSchemaGenerator(fontMetrics);
            
            try
            {
              
              //String schemaText = gsg .processXSD(url, rootElement,
              // optionalAttributes, optionalElements, generateData);
              
              //System.out.println("**gsg .processXSD");
              
              String schemaText = gsg.processXSD(document, schema, schemaRoot,optionalAttributes, optionalElements, generateData);
            ...
            catch (Exception ex)
            {
              ...
              MessageHandler.showError(parent,
                  "Cannot Generate Graph from Scehma",
                  "Generate Schema Graph Error");
              //System.err.println("exception thrown:" + ex.toString() + "..."
              //    + ex.getMessage());
            }
