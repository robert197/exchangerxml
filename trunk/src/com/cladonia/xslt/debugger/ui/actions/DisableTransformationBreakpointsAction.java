/*
 * $Id: DisableTransformationBreakpointsAction.java,v 1.1 2004/05/23 14:46:43 edankert Exp $
 *
 ...
 * @author Dogsbay
 */
 public class DisableTransformationBreakpointsAction extends AbstractAction {
	 ...
	 */
 	public DisableTransformationBreakpointsAction( XSLTDebuggerPane debugger) {
 		super( "Disable All Breakpoints");

		putValue( MNEMONIC_KEY, new Integer( 'D'));
		putValue( SHORT_DESCRIPTION, "Disable all Breakpoints");
