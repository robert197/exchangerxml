 ...
 */
public class PlainXMLDocument extends AbstractXMLDocument {
     ...
     */
    public PlainXMLDocument() {
	this(new BufferContent());
    }
     ...
     */
    public PlainXMLDocument(Content c) {
		super(c);
...
//		}
	...
	public void cleanup() {
		super.cleanup();
		added.removeAllElements();     // Vector<Element>
		removed.removeAllElements();
	}
	
	protected void finalize() {
		added = null;
		removed = null;   // Vector<Element>
		defaultRoot = null;
	}
}
