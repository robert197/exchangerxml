 ...
 */
public class FoldingBoxView extends FoldingCompositeView {
     ...
     */
    public FoldingBoxView(Element elem, int axis) {
	super(elem);
...
//	int n = getViewCount();
	int n = getElement().getElementCount();
	...
	if(majorAxis == Y_AXIS) {
		...
		if(v != null && v instanceof CompositeView) {
		    return ((FoldingCompositeView)v).flipEastAndWestAtEnds(position,
								    bias);
		}
	    }
	}
