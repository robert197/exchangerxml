...
public class FoldingPlainView extends PlainView implements TabExpander {
    ...
    public float getPreferredSpan(int axis) {
    	...
    	switch (axis) {
	        case View.X_AXIS:
//	        	System.out.println( "getPreferredSpan( X_AXIS) ["+getLineWidth(longLine)+"]");
	        	return getLineWidth(longLine);

	        case View.Y_AXIS:
//	        	System.out.println( "getPreferredSpan( Y_AXIS) ["+getVisibleElementCount() * metrics.getHeight()+"]");
	            return getVisibleElementCount() * metrics.getHeight(); // getElement().getElementCount() * metrics.getHeight();
...
//		System.out.println( "FoldingPlainView.paint() ["+time+"]");
...
//        	System.out.println( "position ["+pos+"] not visible!");
        	return null;
        }
...
//    	System.out.println( "viewToModel( "+fx+", "+fy+", "+a+", "+bias+")");
...
//        	System.out.println( "y["+y+"] > alloc.y + alloc.height ["+(alloc.y + alloc.height)+"]");
