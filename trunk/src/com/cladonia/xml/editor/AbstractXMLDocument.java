 ...
 */
public abstract class AbstractXMLDocument implements Document, Serializable {

	private Vector leafs = null;
     ...
     */
    protected AbstractXMLDocument(Content data) {
     ...
     */
    protected AbstractXMLDocument(Content data, AttributeContext context) {
	this.data = data;
	...
	Integer loadPriority = (Integer) 
	    getProperty(AbstractXMLDocument.AsyncLoadPriority);
	...
	putProperty(AbstractXMLDocument.AsyncLoadPriority, loadPriority);
    }
	...
	if (len > 0) {
            ...
            isComposedTextElement = false; // Utilities.isComposedTextElement(elem);
	...
	public void cleanup() {
		...
		for ( int i = 0; i < leafs.size(); i++) {
			((LeafElement)leafs.elementAt(i)).cleanup();
		}
		
		leafs.removeAllElements();
	}
    ...
    protected Element createLeafElement(Element parent, AttributeSet a, int p0, int p1) {
		LeafElement element = new LeafElement(parent, a, p0, p1);
		leafs.addElement( element);
		return element;
    }
...
//	}
	...
	public Document getDocument() {
	    return AbstractXMLDocument.this;
	}
