 ...
 * Window - Preferences - Java - Code Generation - Code and Comments
 */
public class GraphicalSchemaGenerationDialog extends XngrDialog /*implements ActionListener*/ {
	...
	public GraphicalSchemaGenerationDialog( ExchangerEditor parent, ConfigurationProperties props) {
		super( parent, true);
		
		setResizable( true);
		setTitle( "Graphical Schema Generation");
		setDialogDescription( "Generate Graph from XML Schema.");
...
*/
	...
	public void show( ExchangerDocument document) { // SOAPException, SAXParseException, IOException {
		this.document = document;
			...
			setTitle( "Graphical Schema Generator []","XML Schema Document");
